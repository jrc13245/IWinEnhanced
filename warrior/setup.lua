...
function SlashCmdList.IWINWARRIOR(command)
	...
	elseif arguments[1] == "ragecost" then
	    ...
	    DEFAULT_CHAT_FRAME:AddMessage("|cff0066ff  Cleave: |r" .. tostring(IWin_RageCost["Cleave"]))
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff0066ff /iwin sunder [|r" .. IWin_Settings["sunder"] .. "|cff0066ff]:|r Use Sunder Armor priority as DPS. (high, once, low, off)")
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff0066ff /iwin ragecost:|r Show current rage costs for Heroic Strike, Sunder Armor, Cleave, Whirlwind.")
    end
end